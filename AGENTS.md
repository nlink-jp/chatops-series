# AGENTS.md — chatops-series

## Project summary

Umbrella repository for nlink-jp's Slack ChatOps automation and monitoring
tools (bot-authenticated). Each tool lives in its own repository, included
here as a submodule. The catalog — one row per tool — is
[README.md](README.md); this file covers only how to work with the umbrella
(ADR-005).
...
| Command | Purpose |
|---------|---------|
| `git clone --recurse-submodules https://github.com/nlink-jp/chatops-series.git` | Clone with all tools |
...
Repository: `github.com/nlink-jp/chatops-series`
